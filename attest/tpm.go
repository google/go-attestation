...
type tpmBase interface {
	...
	loadSK(opaqueBlob []byte) (*SK, error)
	newSK(ak *AK, opts *SKConfig) (*SK, error)
...
func (t *TPM) NewSK(ak *AK, opts *SKConfig) (*SK, error) {
...
// to this function.
func (t *TPM) LoadSK(opaqueBlob []byte) (*SK, error) {
